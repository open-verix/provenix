...
require (
	...
	github.com/docker/cli v29.2.0+incompatible // indirect; Security fix: CVE-2025-15558
	...
	go.opentelemetry.io/otel/sdk v1.40.0 // indirect; Security fix: CVE-2026-24051
